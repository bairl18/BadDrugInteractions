...
<?php
   ...
   /* Usage: http://ec2-13-58-76-35.us-east-2.compute.amaonaws.com/test2.php?id1=[drug_id_1]&id2=[drug_id_2] */
   $drug_id_1 = $_GET["id1"];
   $drug_id_2 = $_GET["id2"];
...
<?php
   ...
   $result = mysqli_query($connection, "SELECT int_id FROM int_drug_interactions WHERE drug_id_1 = '" . $drug_id_1 . "' AND drug_id_2 = '" . $drug_id_2 . "'" );
