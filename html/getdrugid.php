...
<?php
   ...
   /* Usage: http://ec2-13-58-76-35.us-east-2.compute.amaonaws.com/test2.php?synid=[drug_synonym_id] */
   $drug_synonym_id = $_GET["synid"];
...
<?php
   ...
   $result = mysqli_query($connection, "SELECT drug_id FROM multum_drug_name_map WHERE drug_synonym_id = " . $drug_synonym_id . " LIMIT 1" );
